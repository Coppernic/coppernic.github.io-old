...
* You may have adb installed on your computer, this program is not necessary when updating via SD card.
...
To realize this operation a microSD of minimum 2 G Bytes is necessary.
...
- Hold `PPWER & Vol. UP` buttons until getting in the Recovery menu,

![](_media/cone2_update_2.png)

![](_media/cone2_update_3.png)

- Press `VOLUME +/-` to select “Apply update from SD card” then press `POWER` Button,

![](_media/cone2_update_4.png)

- Press `VOLUME +/-` Down to select `update...zip` file.
...
- C-One2 is ready to be configured.
